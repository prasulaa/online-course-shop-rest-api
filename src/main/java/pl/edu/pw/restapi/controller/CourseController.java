...
public class CourseController {
    ...
    @PostMapping
    public ResponseEntity<CourseDetailsDTO> createCourse(@RequestBody @Valid CreateCourseDTO course,
    ...
    public ResponseEntity<Void> buyCoursePaymentNotification(@RequestParam("id") Long courseId,
        ...
        if (verifyPayuSignature(body, singature)) {
            PayuNotification notification = objectMapper.readValue(body, PayuNotification.class);
            courseService.boughtCourse(courseId, user, notification);
